...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    vars.put("temp", "xpath=//a[contains(@href, \'/reset\')]");
    assertEquals(vars.get("temp").toString(), "xpath=//a[contains(@href, \'/reset\')]");
  }
  ...
  public void tEST4LISTING() {
    driver.get("http://localhost:8080/");
    driver.findElement(By.linkText("Catalog")).click();
    assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(1)")).getText(), is(not("Rented out")));
    assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(2)")).getText(), is(not("Rented out")));
    assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(3)")).getText(), is(not("Rented out")));
    assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(3)")).getText(), is("ID 3. Mistoffelees"));
  }
  ...
  public void tEST11GREETACATWITHNAME() {
    ...
    vars.put("tmp", driver.findElement(By.xpath("//div[@id=\'greeting\']/h4")).getText());
    assertEquals(vars.get("tmp").toString(), "Meow! from Jennyanydots.");
  }
